...
// create marker
 ...
 marker.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div><b>🚘 &nbsp;'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>').addTo(map);
...
var icon1=L.mapbox.marker.icon({'marker-symbol': 'police', 'marker-color': current_val[17]})  
  ...
  // marke.addTo(map);
  marke1.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div>🚘 &nbsp;Plaque <b>'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>💳 &nbsp;<a href="#" title="'+current_val[21]+'" onclick="get_donne_permis(this.title)">'+current_val[21].toUpperCase()+'</a></b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>');
...
var icon2=L.mapbox.marker.icon({'marker-symbol': 'police', 'marker-color': current_val[17]})
  ...
  // marke.addTo(map);
  marke2.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div><b>🚘 &nbsp;'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>');
...
var icon3=L.mapbox.marker.icon({'marker-symbol': 'police', 'marker-color': current_val[17]})
  ...
  // marke.addTo(map);
  marke3.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div><b>🚘 &nbsp;'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>');
...
var icon6=L.mapbox.marker.icon({'marker-symbol': 'police', 'marker-color': current_val[17]})
  ...
  // marke.addTo(map);
  marke6.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div><b>🚘 &nbsp;'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>');
  ...
  // marke.addTo(map);
  marke7.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div><b>🚘 &nbsp;'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>');
 ...
 if (current_val[16]==2) {
  ...
  // marke.addTo(map);
  marke4.bindPopup('<div class="card"><div class="card-header text-center"><h4><font color="white"><b>'+current_val[2]+'</b></font></h4></div><div class="card-body"><div><b>🚘 &nbsp;'+current_val[3].toUpperCase()+'</b><br>🤵🏽‍♂️ &nbsp;De <b>'+current_val[22].toUpperCase()+'</b><br>🗓️ &nbsp;'+current_val[4]+'<br>👮🏾 &nbsp;'+current_val[5]+',<br>📚 &nbsp;N°'+current_val[7]+' <br>📍 &nbsp;'+current_val[14]+'<br>💵&nbsp; Amende de '+current_val[13]+'<br><a href="#" onclick="getDetailControl('+current_val[15]+')">🧐 &nbsp;voir plus..</a><hr><a href="#" onclick="get_detail_Pdl('+current_val[19]+','+current_val[20]+')">✉️ &nbsp; '+current_val[20]+' ...</a></b><br><a href="#" onclick="get_detail_performance('+current_val[19]+')">🧐 &nbsp; Total PV</a></div></div></div>');
