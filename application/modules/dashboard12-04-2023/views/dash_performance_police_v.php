...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <label >Du</label>
     ...
     <input type="date" class="form-control input-sm" onchange="submit();submit_mois()" name="DATE_UNE" id="DATE_UNE" value="<?=set_value('DATE_UNE')?>"min="<?=$ego2?>" max="<?=$ego1?>"> 
 </div>   


<div class="form-group col-md-2">
  <label >Au</label>
 <input type="date" class="form-control input-sm" onchange="submit();" name="DATE_DEUX" id="DATE_DEUX" value="<?=set_value('DATE_DEUX')?>" min="<?=set_value('DATE_UNE')?>" max="<?=$ego1?>">
