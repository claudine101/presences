...
<div class="row column1">
  <div class="col-md-12">
   <div class="white_shd full margin_bottom_10">
    <div class="full graph_head">
      <div class="row" style="margin-top: 0px">
<div class="form-group col-md-6"><h4 style='color:#FFFFFF'>Tableau de bord des immatriculation</h4></div>
...
$.ajax({
url : "<?=base_url()?>dashboard/Dashboard_Immatriculation_obr/get_rapport",
type : "POST",
dataType: "JSON",
cache:false,
data:{
