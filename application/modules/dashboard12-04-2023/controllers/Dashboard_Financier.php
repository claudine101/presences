        ...
        line: {
            ...
            depth: 40,
             ...
             point:{
                events: {
                  click: function(){
$(\"#titre1\").html(\"Détail des amende de signalement \");
$(\"#myModal1\").modal();
...
\"sSortAscending\":  \": activer pour trier la colonne par ordre croissant\",
 \"sSortDescending\": \": activer pour trier la colonne par ordre d&eacute;croissant\"
  ...
  text: \"Mediabox\"
    ...
    series: [{
        name: 'Amende  retenue: (" . number_format($nombre, 0, '.', ' ') . ")',
        color:'green',
        data: [".$datas."]
    },
    {
        name: 'Amende annule : (" . number_format($nombrean, 0, '.', ' ') . ")',
        color:'red',
        data: [".$datasan."]
    }]
});
...
$rapp1="<script type=\"text/javascript\">
    ...
    title: {
        text: ' Total Amende par contrôle ".$titre."'
    },
    subtitle: {
        ...
        column: {
            ...
            depth: 40,
             ...
             point:{
                events: {
                  click: function(){
$(\"#titre\").html(\"Détail des amendes de contrôle \");
$(\"#myModal\").modal();
var row_count ='1000000';
$(\"#mytable\").DataTable({
\"processing\":true,
...
\"sSortAscending\":  \": activer pour trier la colonne par ordre croissant\",
 \"sSortDescending\": \": activer pour trier la colonne par ordre d&eacute;croissant\"
  ...
  text: \"Mediabox\"
    ...
    series: [{
        name: 'Amende en ettente de validation : (" . number_format($total_att, 0, '.', ' ') . ")',
        color:'orange',
        data: [".$data_att."  ]
    },
    {
        name: 'Amende validé par la police au poste : (" . number_format($total_valip, 0, '.', ' ') . ")',
        color:'green',
        data: [".$data_valip."  ]
    }
    ,
    {
        name: 'Amende validé après traitement par le centre OPS : (" . number_format($total_valap, 0, '.', ' ') . ")',
        color:'blue',
        data: [".$data_valap."  ]
    }
    ,
    {
        name: 'Amende annulé par la police au poste : (" . number_format($total_ann, 0, '.', ' ') . ")',
        color:'red',
        data: [".$data_ann."  ]
    }]
});
