...
class Voiture_Marque extends CI_Controller
{
	...
	function add()
	{
		$this->form_validation->set_rules('DESCRIOTION','', 'trim|required|callback_validate_name',array('required'=>'<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));
