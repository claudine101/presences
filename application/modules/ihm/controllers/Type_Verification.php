...
class Type_Verification extends CI_Controller
{
	...
	function add()
	{
		$this->form_validation->set_rules('VERIFICATION', '', 'trim|required|callback_validate_name', array('required' => '<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));
