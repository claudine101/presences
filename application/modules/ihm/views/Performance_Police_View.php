                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-4">
                      <form method="post" id="myForma" action="<?=base_url('ihm/Performance_Police/index/'.$this->uri->segment(4))?>">
                        <label>Date</label>
                        <input class="form-control input-sm" type="date" data-live-search="true" value="<?=$trove?>"  name="DATE_VERIFIF"  id="DATE_VERIFIF" onchange="changeDate()">
...
<script>
  ...
  Highcharts.chart('containerRqpport', {
    ...
    title: {
        text: 'Performance   <?=   number_format($nomb, 0, ',', ' '); ?> contrôles / Total <?=   number_format($total, 0, ',', ' '); ?> FBU<br>'
    },
    subtitle: {
        text: ''
    },
