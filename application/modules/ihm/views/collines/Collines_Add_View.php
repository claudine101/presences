          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form  name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Collines/add'); ?>" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-control input-sm" name="COMMUNE_ID" id="COMMUNE_ID" onchange='get_zones()'>
                          <option value="">------------Selectionner----------</option>
                        </select>
                    <?php echo form_error('COMMUNE_ID', '<div class="text-danger">', '</div>'); ?> 
                  </div>
                  <div class="col-md-6">
                    <label for="FName">Zones</label>
                    <select class="form-control input-sm" name="ZONE_ID" id="ZONE_ID" onchange='liste()'>
                          <option value="">------------Selectionner----------</option>
                        </select>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="COLLINE_NAME" autocomplete="off" id="COLLINE_NAME" value="<?= set_value('COLLINE_NAME') ?>"  class="form-control">
