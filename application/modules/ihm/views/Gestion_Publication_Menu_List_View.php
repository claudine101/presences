           ...
           <div class="col-sm-4 text-right">
            ...
            <span style="margin-right: 15px">
              <div class="row">
                ...
                <div class="col-sm-6" style="float:right;">
                  <a href="<?=base_url('ihm/Gestion_Publication_Menu/ajouter')?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
<script type="text/javascript">
  ...
  {  
    ...
    $("#reponse1").DataTable({
      ...
      "oreder":[],
      "ajax":{
        url: "<?php echo base_url('ihm/Gestion_Publication_Menu/listing/');?>", 
        type:"POST",
