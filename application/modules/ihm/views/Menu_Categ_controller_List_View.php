          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4 text-right">
              ...
              <span style="margin-right: 15px">
                ...
                <div class="col-sm-6" style="float:right;">
                  <a href="<?=base_url('ihm/Menu_Categ_controller/ajouter')?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
{  
  $('#message').delay('slow').fadeOut(3000);
   $("#reponse1").DataTable({
    ...
    "oreder":[],
    "ajax":{
      url: "<?php echo base_url('ihm/Menu_Categ_controller/listing/');?>", 
      type:"POST",
      data : {   },
      beforeSend : function() {
      }
