            ...
            <div class="col-sm-4 text-right">
              ...
              <span style="margin-right: 15px">
                <div class="col-sm-3" style="float:right;">
                  <a href="<?= base_url('ihm/Money/ajouter') ?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
< <script type="text/javascript">
  ...
  "ajax":{
  url: "<?php echo base_url('ihm/Money/listing/'); ?>",
  type:"POST",
  data : { },
  beforeSend : function() {
  }
  ...
  function supprimer(id,nom=null,prenom=null){
    Swal.fire({
      title: 'Souhaitez-vous Supprimer la monnaie '+nom+' '+prenom,
      showDenyButton: true,
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>ihm/Money/delete/"+id,
          type : "DELETE",
          dataType: "JSON",
          cache:false,
          data: {},
 ...
 function activer(id,nom=null,prenom=null){
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>ihm/Money/activer/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
 ...
 function desactiver(id,nom=null,prenom=null){
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>ihm/Money/desactiver/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
