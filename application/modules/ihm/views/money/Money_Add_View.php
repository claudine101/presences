          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                 ...
                 <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('ihm/Money/add'); ?>">
                  <div id="add">
                 <div class="row">
                  <div class="col-md-6">
                    <label for="FName">Monnaie</label>
                    <input type="text" name="MONEY" autocomplete="off" id="MONEY" value="<?= set_value('MONEY') ?>"  class="form-control">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="SYMBOLE" autocomplete="off" id="SYMBOLE" value="<?= set_value('SYMBOLE') ?>"  class="form-control">  
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <select required class="form-control form-control-sm" name="ID_PAYS" id="ID_PAYS" onchange="onSelected();">
                        ...
                        ?>
                          <option value="<?= $value['COUNTRY_ID'] ?>"><?= $value['CommonName'] ?></option>
                        <?php
                        }
                        ?>
                      </select>
