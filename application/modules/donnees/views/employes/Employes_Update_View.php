      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?= base_url('donnees/Employes/index') ?>" class='btn btn-primary float-right'>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('donnees/Employes/update'); ?>">
                  <div id="add">
                  <div class="row">
                    <div class="col-md-6">
                      <label for="FName">Nom</label>
                      <input type="hidden" class="form-control" name="ID_EMPLOYE" value="<?= $data['ID_EMPLOYE'] ?>">
                      <input type="text" name="NOM_EMPLOYE" autocomplete="off" id="NOM_EMPLOYE" value="<?= $data['NOM_EMPLOYE'] ?>"  class="form-control" >
                      <?php echo form_error('NOM_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>


                    <div class="col-md-6">
                      <label for="FName">Prenom</label>
                      <input type="text" name="PRENOM_EMPLOYE" autocomplete="off" id="PRENOM_EMPLOYE" value="<?= $data['PRENOM_EMPLOYE'] ?>"  class="form-control">
                      <?php echo form_error('PRENOM_EMPLOYE', '<div class="text-danger">', '</div>'); ?>

                    </div>
                    <div class="col-md-6">
                      <label for="FName">Numero CNI</label>
                      <input type="text" name="NUMERO_CNI_EMPLOYE" autocomplete="off" id="NUMERO_CNI_EMPLOYE" value="<?= $data['NUMERO_CNI_EMPLOYE'] ?>" class="form-control">
                      <?php echo form_error('NUMERO_CNI_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName">Téléphone</label>
                      <input type="tel" name="TELEPHONE_EMPLOYE" autocomplete="off" id="TELEPHONE_EMPLOYE"  value="<?= $data['TELEPHONE_EMPLOYE'] ?>" class="form-control">

                      <?php echo form_error('TELEPHONE_EMPLOYE', '<div class="text-danger">', '</div>'); ?>

                    </div>
                    <div class="col-md-6">
                      <label for="FName"> Email</label>
                      <input type="text" name="EMAIL_EMPLOYE" autocomplete="off" id="EMAIL_EMPLOYE" value="<?= $data['EMAIL_EMPLOYE'] ?>" class="form-control">

                      <?php echo form_error('EMAIL_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName"> Date de naissance</label>
                       <input type="date" name="DATE_NAISSANCE_EMPLOYE" autocomplete="off" id="DATE_NAISSANCE_EMPLOYE" value="<?= $data['DATE_NAISSANCE_EMPLOYE'] ?>" class="form-control">
                    ...
                    <?php
                      ...
                      <select class="form-control" name="SEXE_EMPLOYE" id="SEXE_EMPLOYE">
                        ...
                        foreach ($sexes as $value) {
                          $selected = "";
                          if ($value['SEXE'] == $data['SEXE_EMPLOYE']) {
                            $selected = "selected";
                          }
                      ...
                      <?php echo form_error('SEXE_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-control" name="ID_COLLINE_EMPLOYE" id="ID_COLLINE_EMPLOYE" >
                        <option value="">---Sélectionner---</option>
                        <?php
