          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('donnees/Employes/add'); ?>">
                  <div id="add">
                  <div class="row">
                    <div class="col-md-6">
                      <label for="FName">Nom</label>
                      <input type="text" name="NOM_EMPLOYE" autocomplete="off" id="NOM_EMPLOYE" value="<?= set_value('NOM_EMPLOYE') ?>" class="form-control" >
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="PRENOM_EMPLOYE" autocomplete="off" id="PRENOM_EMPLOYE" value="<?= set_value('PRENOM_EMPLOYE') ?>" class="form-control">
                      <?php echo form_error('PRENOM_EMPLOYE', '<div class="text-danger">', '</div>'); ?>

                    </div>
                    <div class="col-md-6">
                      <label for="FName">Numero CNI</label>
                      <input type="text" name="NUMERO_CNI_EMPLOYE" autocomplete="off" id="NUMERO_CNI_EMPLOYE" value="<?= set_value('NUMERO_CNI_EMPLOYE') ?>" class="form-control">
                      <?php echo form_error('NUMERO_CNI_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName">Téléphone</label>
                      <input type="tel" name="TELEPHONE_EMPLOYE" autocomplete="off" id="TELEPHONE_EMPLOYE" value="<?= set_value('TELEPHONE_EMPLOYE') ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="EMAIL_EMPLOYE" autocomplete="off" id="EMAIL_EMPLOYE" value="<?= set_value('EMAIL_EMPLOYE') ?>" class="form-control">

                      <?php echo form_error('EMAIL_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName"> Date de naissance</label>
                      <input type="date" name="DATE_NAISSANCE_EMPLOYE" autocomplete="off" id="DATE_NAISSANCE_EMPLOYE" value="<?= set_value('DATE_NAISSANCE_EMPLOYE') ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <?php echo form_error('ID_COLLINE_EMPLOYE', '<div class="text-danger">', '</div>'); ?>
                    </div>
