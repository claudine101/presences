          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('appertement/Enclos/update_habitant'); ?>">
                  <div id="add">
                  <div class="row">
                    
                    <div class="col-md-6">
                      <input type="hidden" class="form-control" name="ID_HABITANT" value="<?= $membre['ID_HABITANT'] ?>">
                     ...
                     <!--  <select  required class="form-control" name="ID_APPARTEMENT" id="ID_APPARTEMENT">
                        ...
                        ?>
                          <option value="<?= $value['ID_APPARTEMENT'] ?>"><?= $value['NOMBRE_CHAMBRE'] ?></option>
                        <?php
                        }
                        ?>
                      </select> -->
                      <select class="form-control" name="ID_APPARTEMENT" id="ID_APPARTEMENT >
                        <!-- <option value="">---Sélectionner---</option> -->
                        <?php
                        foreach ($appartement as $key) {
                          $selected = "";
                          if ($key['ID_APPARTEMENT'] == $membre['ID_APPARTEMENT']) {
                            $selected = "selected";
                          }
                        ?>
                          <option value="<?= $key['ID_APPARTEMENT'] ?>" <?= $selected ?>>
                            <?= $key['NOMBRE_CHAMBRE'] ?></option>
                        <?php
                        }
                        ?>
                      </select>
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="CNI" autocomplete="off" id="CNI" value="<?= $membre['NUMERO_IDENTITE'] ?>" class="form-control">
                   ...
                   <div class="col-md-6">
                      ...
                      <input type="text" name="LIEU_DELIVRANCE" autocomplete="off" id="LIEU_DELIVRANCE" value="<?= $membre['LIEU_DELIVRANCE'] ?>" class="form-control">
                      <?php echo form_error('LIEU_DELIVRANCE', '<div class="text-danger">', '</div>'); ?>

                    </div>
                    <div class="col-md-6">
                      <label for="FName">Date de délivrance</label>
                      <input type="date" name="DATE_DELIVRANCE" autocomplete="off" id="DATE_DELIVRANCE" value="<?= $membre['DATE_DELIVRANCE'] ?>" class="form-control">
                      <?php echo form_error('DATE_DELIVRANCE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName">PERE</label>
                      <input type="text" name="PERE" autocomplete="off" id="PERE" value="<?= $membre['PERE'] ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="MERE" autocomplete="off" id="MERE" value="<?= $membre['MERE'] ?>" class="form-control">
                      <?php echo form_error('MERE', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName">TELEPHONE</label>
                      <input type="text" name="NUMERO_TELEPHONE" autocomplete="off" id="NUMERO_TELEPHONE"  value="<?= $membre['NUMERO_TELEPHONE'] ?>" class="form-control">
                    ...
                    elseif($profil==22) { ?>
                      ...
                      <select class="form-control" name="ID_AVENUE" id="ID_AVENUE" onchange="autre();">
                        ...
                        foreach ($avenues as $key) {
                          $selected = "";
                          if ($key['AVENUE_ID'] == $membre['ID_AVENUE']) {
                            $selected = "selected";
                          }
                        ?>
                      ...
                      <?php echo form_error('AVENUS_ID', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    ...
                    elseif($profil==21) { ?>
                      ...
                      <select class="form-control" name="ID_COLLINE" id="ID_COLLINE" onchange="get_avenuesUpdate();">
                        <!-- <option value="">---Sélectionner---</option> -->
                        <?php
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-control" name="ID_ETAT_CIVIL" id="ID_ETAT_CIVIL >
                        <!-- <option value="">---Sélectionner---</option> -->
                        <?php
                        foreach ($eta_civils as $key) {
                          $selected = "";
                          if ($key['ID_ETAT_CIVIL'] == $membre['ID_ETAT_CIVIL']) {
                            $selected = "selected";
                          }
                        ?>
                          <option value="<?= $key['ID_ETAT_CIVIL'] ?>" <?= $selected ?>>
                   ...
                   <select class="form-control" name="ID_FONCTION" id="ID_FONCTION >
                        <!-- <option value="">---Sélectionner---</option> -->
                        <?php
                        foreach ($fonctions as $key) {
                          $selected = "";
                          if ($key['ID_FONCTION'] == $membre['ID_FONCTION']) {
                            $selected = "selected";
                          }
                        ?>
                          <option value="<?= $key['ID_FONCTION'] ?>" <?= $selected ?>>
                            <?= $key['FONCTION_NAME'] ?></option>
                        <?php
                        }
                        ?>
                      </select>
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      ...
                      <select class="form-control" name="ID_HABITANT_ROLE" id="ID_HABITANT_ROLE >
                        <!-- <option value="">---Sélectionner---</option> -->
                        <?php
                        foreach ($roles as $key) {
                          $selected = "";
                          if ($key['ID_HABITANT_ROLE'] == $membre['ID_HABITANT_ROLE']) {
                            $selected = "selected";
                          }
                        ?>
                          <option value="<?= $key['ID_HABITANT_ROLE'] ?>" <?= $selected ?>>
                            <?= $key['NOM_ROLE'] ?></option>
                        <?php
                        }
                        ?>
                    ...
                    <div class="col-md-6 row">
                      <div class="col-md-3" style="margin-top:10px">
                        <label for="Ftype">Photo CNI 1</label></BR>
                        <label class="label" data-toggle="tooltip" title="Attacher un fichier">
                          <font style="font-size: 40PX;color: green"><i class="fas fa-image rounded" id="avatar" alt="avatar"></i></font>
                          <input type="file" class="sr-only" id="IMAGE1_CNI" name="IMAGE1_CNI" accept="image/*" >
                        </label>
                      </div>
                       <div class="col-md-3" style="margin-top:-8px">
                        <label for="text" style="font-size: 5px;" id="fileName"></label>
                        <div class="col-md-12" style="margin-top: 5px" id="resultGet_cni1"></div>                   
                      </div>
                    </div>
                    <div class="col-md-6 row">
                      <!-- <div class="col-md-1">
                        <label for="text" style="font-size: 10px;top:" id="fileName"></label> -->
                        <div class="col-md-3" style="margin-top:10px">
                        <label for="Ftype">Photo CNI 2</label></BR>
                      </BR>
                        <label class="label" data-toggle="tooltip" title="Attacher un fichier">
                          <font style="font-size: 40PX;color: green"><i class="fas fa-image rounded" id="avatar" alt="avatar"></i></font>
                       ...
                       <div class="col-md-6" style="margin-top:-8px">
                        <label for="text" style="font-size: 5px;" id="fileName"></label>
                        <div class="col-md-12" style="margin-top: 5px" id="resultGet_cni2"></div>                   
                      </div>
                    </div>
...
<script>
 ...
 function get_avenues(ID_AVENUE=0){
    ...
    if (ID_COLLINE == '') {
      ...
      $.ajax({
        url: "<?= base_url() ?>Appertement/Enclos/get_avenuesAdd/" + ID_COLLINE+"/"+ID_AVENUE,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          $('#ID_AVENUE').html(data);
...
function save_newAvenue(){
   ...
   if (ID_COLLINE == "") {
    ...
    $.ajax({
      url : "<?= base_url() ?>Appertement/Enclos/save_avenue",
      type : "POST",
      dataType: "JSON",
      data : dataU,
      processData: false,
  ...
  $("#IMAGE1_CNI").change(function() {
    readURL_cni1(this);
  });
  $("#IMAGE2_CNI").change(function() {
    readURL_cni2(this);
  });
</script>
