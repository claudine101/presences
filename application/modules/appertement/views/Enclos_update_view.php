          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('appertement/Enclos/update'); ?>">
                  <div id="add">
                  <div class="row">
                    <div class="col-md-6">
                      <input type="hidden" class="form-control" name="ID_MAISON" value="<?= $membre['ID_MAISON'] ?>">
                      <input type="hidden" class="form-control" name="phone_old" value="<?= $membre['NUMERO_CITOYEN'] ?>">
                      <label for="FName">Nom</label>
                      <input type="text" name="NOM" autocomplete="off" id="NOM" value="<?= $membre['NOM_CITOYEN'] ?>" class="form-control" >
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="PRENOM" autocomplete="off" id="PRENOM" value="<?= $membre['PRENOM_CITOYEN'] ?>" class="form-control">
                      <?php echo form_error('PRENOM', '<div class="text-danger">', '</div>'); ?>

                    </div>
                    <div class="col-md-6">
                      <label for="FName">Téléphone</label>
                      <input type="text" name="phone" autocomplete="off" id="phone" value="<?= $membre['NUMERO_CITOYEN'] ?>" class="form-control">
                      <?php echo form_error('phone', '<div class="text-danger">', '</div>'); ?>
                    </div>
                    <div class="col-md-6">
                      <label for="FName"> Email</label>
                      <input type="text" name="EMAIL" autocomplete="off" id="EMAIL" value="<?=$membre['NOM_UTILISATEUR'] ?>" class="form-control">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="tel" name="ADRESSE" autocomplete="off" id="ADRESSE" value="<?= $membre['ADRESSE'] ?>"  class="form-control">
