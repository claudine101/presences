            ...
            <div class="col-sm-8 text-right">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-header" style="background: black;">
                            <div id="title"><b><h4 style="color:#fff;font-size: 18px;">Importation fichier Permis</h4></b></div>
              ...
              <div class="col-md-3">
                ...
                <div class="modal fade" id="myControle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div  class="modal-dialog" role="document">
                    <div class="modal-content">
                      <form action="<?= base_url() ?>PSR/Obr_immatricUlation/controle_permis"; method="post"  enctype="multipart/form-data" id='myform_controle'>
                        <div class="modal-header" style="background: black;">
                            <div id="title"><b><h4 style="color:#fff;font-size: 18px;">Contrôle permis</h4></b></div>
                            <div class="close" style="color:#fff" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">&times;</span>
                            </div>
                        </div>
                        <div  id="concernediv" class="modal-body">
                          <div class="form-group col-lg-12"><div class="col-lg-12 col-md-12 col-sm-12 form-group" id="form1">
                              <input type="text" name="NUMERO_PERMIS" id="NUMERO_PERMIS" class="form-control" placeholder="Numéro permis">
                              <div><?php echo form_error('IMEI');?></div>
                            </div>
                          </div>
                        </div>
...
< <script type="text/javascript">
  ...
  function save(){
   ...
   Swal.fire({
      title: 'Souhaitez-vous effectuer un contrôle rapide sur le permis numéro '+NUMERO_PERMIS+' ?',
      showDenyButton: true,
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>PSR/Chauffeur_permis/controle_permis/",
          type : "POST",
          dataType: "JSON",
          cache:false,
          ...
          success:function(data) {
             ...
             $('#concernediv').html('<div class="form-group col-lg-12"><div class="col-lg-12 col-md-12 col-sm-12 form-group" id="form1"><input type="text" name="NUMERO_PERMIS" id="NUMERO_PERMIS" class="form-control" placeholder="Numéro permis"><div><?php echo form_error("IMEI");?></div></div></div>')
            $('#idbutton').prop('disabled',false)
            console.log(data);
            Swal.fire('Confirmé!', '', 'success')
            show_permis(NUMERO_PERMIS)
          },
          error:function() {
