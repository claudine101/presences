            ...
            <div class="col-sm-4 text-right">
              ...
              <span style="margin-right: 15px">
                <div class="col-sm-3" style="float:right;">
                  <a href="<?=base_url('PSR/Psr_elements/ajouter')?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
< <script type="text/javascript">
  ...
  {  
    ...
    $("#reponse1").DataTable({
      ...
      "ajax":{
        url: "<?php echo base_url('PSR/Psr_elements/listing/');?>", 
        type:"POST",
        data : {   },
        beforeSend : function() {
        }
  ...
  function activer(id,nom=null,prenom=null){
    Swal.fire({
      title: 'Souhaitez-vous activer  '+nom+' '+prenom,
      showDenyButton: true,
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>PSR/Psr_elements/activer/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
 ...
 function desactiver(id,nom=null,prenom=null){
    Swal.fire({
      title: 'Souhaitez-vous désactiver  '+nom+' '+prenom,
      showDenyButton: true,
      confirmButtonText: 'Maintenant',
      denyButtonText: `Pas maintenant`,
    }).then((result) => {
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>PSR/Psr_elements/desactiver/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
 ...
 function supprimer(id,nom=null,prenom=null){
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>PSR/Psr_elements/delete/"+id,
          type : "DELETE",
          dataType: "JSON",
          cache:false,
          data: {},
