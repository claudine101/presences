                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <label for="FName">Niveau  alerte</label>
                           <textarea  name="NIVEAU_ALERTE" autocomplete="off" id="FR" value="<?= set_value('NIVEAU_ALERTE') ?>" class="form-control">  </textarea>
                        ...
                        <div class="col-md-6">
                          ...
                          <textarea readonly name="INFRACTION_TRADUCTION" autocomplete="off" id="INFRACTION_TRADUCTION" value="<?= set_value('INFRACTION_TRADUCTION') ?>" class="form-control">  </textarea>
