          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form name="myform" method="post" class="form-horizontal" enctype="multipart/form-data"  action="<?= base_url('PSR/Assureur/update'); ?>">

                  <div class="row">
                    <input type="hidden" class="form-control" name="ID_ASSUREUR" value="<?= $data['ID_ASSUREUR'] ?>">


                    <div class="col-md-6">
                      <label for="FName">Nom</label>
                      <input type="text" name="ASSURANCE" value="<?= $data['ASSURANCE'] ?>" id="ASSURANCE" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="number" name="TELEPHONE" id="TELEPHONE" value="<?= $data['TELEPHONE']; ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="NIF" value="<?= $data['NIF'] ?>" id="NIF" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="ADRESSE" value="<?= $data['ADRESSE'] ?>" id="ADRESSE" class="form-control">
