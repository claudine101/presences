          ...
          <div class="row mb-2">
            ...
            <span style="margin-right:15px">
              ...
              <div class="col-md-4">
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <form action="<?= base_url() ?>PSR/Controle/add_excel"; method="post"  enctype="multipart/form-data" id='myform'>
                        <div class="modal-header" style="background: black;">
                            <div id="title"><b><h4 style="color:#fff;font-size: 18px;">Importation fichier contrôle technique</h4></b></div>
                ...
                <div class="col-md-2">
                  <a href="<?= base_url('PSR/Controle/ajouter') ?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
< <script type="text/javascript">
  function liste()
  {
    ...
    $("#reponse1").DataTable({
      ...
      "oreder":[],
      "ajax":{
        url: "<?php echo base_url('PSR/Controle/listing/'); ?>",
        type:"POST",
        data : { },
        beforeSend : function() {
        }
