          ...
          <span style="margin-right:15px">
            <div class="row">
             ...
             <div class="col-md-3">
              ...
              <div class="col-md-2">
                  <a href="<?= base_url('PSR/Obr_Immatriculation/ajouter') ?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
                    <i class="nav-icon fas fa-plus"></i>
                    Nouveau
                  </a>
              </div>
            </div>
<!-- MODAL POUR  FAIRE CONTROLE RAPIDE SUR  WEB -->
...
<!-- MODAL FIN POUR  FAIRE CONTROLE RAPIDE SUR  WEB -->
<!-- MODAL POUR  IMPORTER LES FICHIER EXCEL -->
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <form action="<?= base_url() ?>PSR/Obr_immatriculatiodn/add_excel"; method="post"  enctype="multipart/form-data" id='myform'>
                        <div class="modal-header" style="background: black;">
                            <div id="title"><b><h4 style="color:#fff;font-size: 18px;">Importation fichier OBR</h4></b></div>
                            <div class="close" style="color:#fff" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">&times;</span>
                            </div>
                        </div>
...
< <script type="text/javascript">
  ...
  "oreder":[],
  "ajax":{
  url: "<?php echo base_url('PSR/Obr_Immatriculation/listing/'); ?>",
  type:"POST",
  data : { },
  beforeSend : function() {
  }
...
function success(NUMERO_PLAQUE ){
  alert("success")
  show_vehicule_detail(NUMERO_PLAQUE)
}
