          ...
          <div class="row mb-2">
            ...
            <span style="margin-right:15px">
              <div class="row">
                ...
                <div class="col-md-2">
                    <a href="<?= base_url('PSR/Declaration_Vol/ajouter') ?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
            ...
            <!-- MODAL POUR  IMPORTATION DE FICHIER  EXCEL -->
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <form action="<?= base_url() ?>PSR/Declaration_Vol/add_excel"; method="post"  enctype="multipart/form-data" id='myform'>
                        <div class="modal-header" style="background: black;">
                            <div id="title"><b><h4 style="color:#fff;font-size: 18px;">Importation fichier PJ</h4></b></div>
            ...
            <!-- MODAL POUR  FAIRE UN CONTROLE RAPIDE COTE WEB -->
...
<script type="text/javascript">
  ...
  "order":[[5,'DESC']],
  "ajax":{
  url: "<?php echo base_url('PSR/Declaration_Vol/listing/'); ?>",
  type:"POST",
  data : { },
  beforeSend : function() {
  }
  ...
  //FUNCTION  POUR  AFFICHER DETAIL DES DIFFERENTS CONTROLE D'UN PLAQUE
//DEVELOPPER PAR  CLAUDINE
//ndayisabaclaudine01@gmail.com
...
//FUNCTION  POUR  EFFECTUER UN CONTROLE RAPIDE 
//DEVELOPPER PAR  CLAUDINE
//ndayisabaclaudine01@gmail.com
  function save(){
