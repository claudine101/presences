             ...
             <div class="row mb-2">
                ...
                <div class="col-sm-4 text-right">
                  <span style="margin-right: 15px" class="col-md-12 row">
                     <div class="col-md-4">
                          <select class="form-control input-sm" name="ID_PSR_INSTITUTION" id="ID_PSR_INSTITUTION" onchange='liste()'>
                      ...
                      <div class="col-md-3" style="float:right;">
                        <a href="<?= base_url('PSR/Utilisateur/ajouter') ?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
< <script type="text/javascript">
  ...
  "order":[[5,'DESC']],
  "ajax":{
  url: "<?php echo base_url('PSR/Psr_institution_user/listing/'); ?>",
  type:"POST",
  data : {
  ID_PSR_INSTITUTION: $('#ID_PSR_INSTITUTION').val(),
  STATUT: $('#STATUT').val(),
  ...
  <script type="text/javascript">
    ...
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>PSR/Utilisateur/activer/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
 ...
 function desactiver(id,nom=null,prenom=null){
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>PSR/Utilisateur/desactiver/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
