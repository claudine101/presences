      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-3">
              <a href="<?=base_url('PSR/Psr_institution/retour')?>" class='btn btn-primary float-right'>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <form  name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Psr_institution/edit'); ?>" enctype="multipart/form-data">
                 
                 <div class="row">
                   <input type="hidden" name="id_inst" autocomplete="off" id="id_inst" class="form-control" value="<?php echo $prs['ID_PSR_INSTITUTION']?>">
                   <div class="col-md-6">
                    <label for="nom_instutition"> Nom de l'institution</label>
                    <input type="text" name="nom_instutition" autocomplete="off" id="nom_instutition" value="<?php echo $prs['NOM_INSTITUTION'] ?>"  class="form-control">
                    
                    <?php echo form_error('nom_instutition', '<div class="text-danger">', '</div>'); ?> 
                  </div>
                  <div class="col-md-6">
                    <label for="personne"> Personne de contact</label>
                    <input type="text" name="personne" autocomplete="off" id="personne" value="<?php echo $prs['PERSONNE_CONTACT'] ?>"  class="form-control">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="telephone" autocomplete="off" id="telephone" value="<?php echo $prs['TELEPHONE_PERSONNE']?>"  class="form-control">
                    
                    <?php echo form_error('telephone', '<div class="text-danger">', '</div>'); ?> 
                  </div>
                  <div class="col-md-6">
                    <label for="email">Email</label>
                    <input type="text" name="email" autocomplete="off" id="email" value="<?php echo $prs['EMAIL_PERSONNE']?>" onkeydown="valide_fn_mail()" onkeyup="valide_fn_mail()" class="form-control">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="adresse" autocomplete="off" id="adresse" value="<?php echo $prs['ADRESSE']?>"  class="form-control">
                 ...
                 <!--  <div class="col-md-6">
                    ...
                    <input type="file" name="signature" autocomplete="off" id="signature" value="<?php //echo $prs['LOGO_INSTITUTION']?>"  class="form-control" accept="image/*">
