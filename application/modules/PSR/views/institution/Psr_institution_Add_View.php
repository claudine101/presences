          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <!-- <form  name="myform" method="post" class="form-horizontal" action="<?//= base_url('PSR/Psr_institution/add'); ?>" enctype="multipart/form-data"> -->


                  <form enctype="multipart/form-data" name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Psr_institution/add'); ?>">
