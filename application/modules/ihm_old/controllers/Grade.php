...
class Grade extends CI_Controller
{
    ...
    {
        $data['title'] = "Grade";
        $this->load->view('Grade_List_View', $data);
    }
    ...
    function add()
    {
        $this->form_validation->set_rules('GRADE', '', 'trim|required|callback_validate_name', array('required' => '<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));
    ...
    function update()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->getOne($this->input->post('ID_GRADE'));
        } else {
            ...
            $this->Modele->update('psr_grade', array('ID_GRADE' => $this->input->post('ID_GRADE')), $data);
