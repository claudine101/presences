...
class Citoyen extends CI_Controller
{
	...
	function add()
	{
		...
		$this->form_validation->set_rules('NOM_UTILISATEUR', '', 'trim|required|callback_validate_email', array('required' => '<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));
