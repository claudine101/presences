                ...
                <form name="myform" method="post" class="form-horizontal" action="<?= base_url('PSR/Assurances/add'); ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <select required class="form-control" name="ID_ASSUREUR" id="ID_ASSUREUR">
                        <option value="">---Sélectionner---</option>
                        <?php
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="number" name="PLACES_ASSURES" autocomplete="off" id="PLACES_ASSURES" value="<?= set_value('PLACES_ASSURES') ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      ...
                      <input required type="number" name="PHONE"  id="PHONE" value="<?= set_value('PHONE') ?>" class="form-control">
