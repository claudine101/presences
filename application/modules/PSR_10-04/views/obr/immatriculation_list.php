                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <form action="<?= base_url() ?>PSR/Obr_immatricUlation/add_excel"; method="post"  enctype="multipart/form-data" id='myform'>
...
< <script type="text/javascript">
 ...
 function show_vehicule(NUMERO_PLAQUE = 0){
   ...
   Swal.fire({
      title: 'Souhaitez-vous effectuer un contrôle rapide sur le plaque numéro?',
      showDenyButton: true,
