...
// fonction d'insertion dans la base de donnee
	...
	function add()
	{
		$this->form_validation->set_rules('nom_instutition','', 'trim|required',array('required'=>'<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));

		$this->form_validation->set_rules('personne','', 'trim|required',array('required'=>'<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));

		$this->form_validation->set_rules('telephone','', 'trim|required|is_unique[psr_institution.TELEPHONE_PERSONNE]',array('required'=>'<font style="color:red;size:2px;">Le champ est Obligatoire</font>',
			'is_unique'=>'<font style="color:red;font-size:8px,">Ce numéro de téléphone existe </font>'));

		$this->form_validation->set_rules('email','', 'trim|required|is_unique[psr_institution.EMAIL_PERSONNE]',array('required'=>'<font style="color:red;size:2px;">Le champ est Obligatoire</font>',
