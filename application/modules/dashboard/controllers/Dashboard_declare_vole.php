...
\"sSortAscending\":  \": activer pour trier la colonne par ordre croissant\",
 ...
 series: [
 {
        ...
        color: '#90EE90',
        name:'Total véhicules déclarés volés : (".number_format($immacat_controlet,0,',',' ').")',
        borderColor:\"#90EE90\", 
...
,
    {
        type: 'columnpyramid',
        color: '#000080',
        name:'Véhicules trouvés : (".number_format($immacat_traite,0,',',' ').")',
        data: [".$immatraite_categorie."]
    },
    {
        type: 'columnpyramid',
       color: '#FF00FF',
         name:' Véhicules non  trouvés : (".number_format($immacat_controle,0,',',' ').")',
