...
$datte_current="CURRENT_TIMESTAMP";   
  ...
  $mois_select="<option selected value=''>Sélectionner</option>";
...
$datjour=$this->Model->getRequete('SELECT DISTINCT DATE_FORMAT(chauffeur_permis.DATE_DELIVER, "%Y-%m-%d") as mois from chauffeur_permis where DATE_FORMAT(chauffeur_permis.DATE_DELIVER, "%Y-%m")="'.$jour.'" ORDER BY mois DESC');
  ...
  $selectjour="<option  selected value=''>Sélectionner</option>";
...
title: {
        text: '<b> Rapport des Permis de conduire  </b> <br> Total : (".number_format($immacat_envoy,0,',',' ').") '
    },
    subtitle: {
        text: '".$titre."'
    },
...
$(\"#titre\").html(\"  Détails de tous les Permis de conduire \");
}else if(this.key2==2){
$(\"#titre\").html(\" Détails des Permis de conduire valides \");
}else{
 $(\"#titre\").html(\" Détails des Permis de conduire expirés \");   
}
...
\"sSortAscending\":  \": activer pour trier la colonne par ordre croissant\",
 ...
 {
        type: 'spline',
         name:'Nombre total des Permis de conduire: (".number_format($immacat_envoy,0,',',' ').")',
        ...
        type: 'column',
        color: '#6610f2',
        name:'Permis de conduire valides : (".number_format($immacat_valable,0,',',' ').")',
        borderColor:\"#f00000\",
    ...
    ,
    {
        type: 'column',
        color: 'red',
        name:'Permis de conduire expirés : (".number_format($immacat_exp,0,',',' ').")',
        borderColor:\"#90EE90\", 
