...
$titre="du  ".strftime('%d-%m-%Y',strtotime(date('Y-m-d')));
      ...
      $control=$this->Model->getRequete("SELECT
          ...
          SUM(CASE WHEN TIME(`DATE_PRESENCE`) > '09:00:00' THEN 1 ELSE 0 END) AS number_of_lates,
          SUM(CASE WHEN TIME(`DATE_PRESENCE`) <= '09:00:00' THEN 1 ELSE 0 END) AS number_of_punctuals
      FROM
