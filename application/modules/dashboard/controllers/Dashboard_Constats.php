...
chart: {
    ...
    title: {
        text: '<b>Nombre total de constats </b><br> Total=".$total_const." '
    },
    subtitle: {
        text: ''
    },
...
$(\"#titre2\").html(\" Détails de constats  \" + this.name);
$(\"#myModal2\").modal();
...
title: {
text: 'Traitement des constats  OBR <br> Total=".number_format($etapetotalobr,0,',',' ')."'
},
subtitle: {
text: ''
},
...
$(\"#titre2\").html(\" Détails de constats: \" + this.key4);
$(\"#myModal2\").modal();
var row_count ='1000000';
$(\"#mytable2\").DataTable({
\"processing\":true,
...
title: {
text: 'Traitement des constats  ASSURANCE <br> Total=".number_format($etapetotalass,0,',',' ')."'
},
subtitle: {
text: ''
},
...
title: {
text: 'Traitement des constats  OTRACO <br> Total=".number_format($etapetotalotra,0,',',' ')."'
},
subtitle: {
text: ''
},
...
title: {
text: 'Traitement des constats  POLICE JURDIQUE <br> Total=".number_format($etapetotalpolice,0,',',' ')."'
},
subtitle: {
text: ''
},
...
title: {
text: 'Traitement des constats  INTERPOL <br> Total=".number_format($etapetotalinterp,0,',',' ')."'
},
subtitle: {
text: ''
},
...
title: {
text: 'Traitement des constats PSR <br> Total=".number_format($etapetotalpsr,0,',',' ')."'
},
subtitle: {
text: ''
},
...
title: {
text: 'Traitement des constats  PARKING <br> Total=".number_format($etapetotalparking,0,',',' ')."'
},
subtitle: {
text: ''
},
...
click: function()
{
$(\"#titre2\").html(\" Liste de constats  : \" + this.key4);
$(\"#myModal2\").modal();
var row_count ='1000000';
$(\"#mytable2\").DataTable({
\"processing\":true,
...
title: {
text: 'Traitement des constats TRANSPORT <br> Total=".number_format($etapetotaltransp,0,',',' ')."'
},
subtitle: {
text: ''
},
