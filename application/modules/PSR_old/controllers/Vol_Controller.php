...
class Vol_Controller extends CI_Controller
{
	...
	function listing()
	{
		...
		$order_column = array('NOM_PROPRIETAIRE','NUMERO_PERMIS', 'NUMERO_PLAQUE', 'NUMERO_SERIE', 'MARQUE_VOITURE', 'DATE_VOLER','DATE_INSERTION', 'VALIDATION', 'STATUT_TRAITEM','STATUT_TRAITEM','IMAGE_1');
