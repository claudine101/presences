...
class Assureur extends CI_Controller
{
...

  {
    ...
    $order_column = array('ASSURANCE', 'EMAIL', 'NIF','TELEPHONE', 'ADRESSE');
  ...
  function validate_email($name)
 {
  ...
  function add()
  {
    ...
    $this->form_validation->set_rules('EMAIL', '', 'trim|required|callback_validate_email', array('required' => '<font style="color:red;size:2px;">Le champ est Obligatoire</font>'));
