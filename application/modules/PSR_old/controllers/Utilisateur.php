...
class Utilisateur extends CI_Controller
{
     ...
     function listing()
     {
          ...
          foreach ($fetch_psr as $row) {
               ...
               $sub_array = array();
               $sub_array[] = '<table> <tbody><tr><td><a href="' . $source . '" target="_blank" ><img alt="Avtar" style="border-radius:50%;width:30px;height:30px" src="' . $source . '"></a></td><td>' . $row->NOM_UTILISATEUR . '</td></tr></tbody></table></a>';
                $sub_array[] = $row->CNI;
